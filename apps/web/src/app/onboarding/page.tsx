...
export default function OnboardingPage() {
  ...
  const handleNext = async () => {
    if (step === 1 && country && language) {
      ...
      // Update the I18n context with the new locale
      // This updates both the context state AND sets the cookie
      ...
      // Navigate using Next.js router (context is already updated)
      router.push('/dashboard');
    }
  };
